  ...
  const handleDownload = async () => {
    try {
      ...
      const addHeader = () => {
        ...
        pdf.text('AERIS-AQ Report', margin, 10);
        ...
        pdf.text(formatted, pageWidth - margin, 10, { align: 'right' });
        return 20;
      };
      ...
      const addFooter = () => {
        ...
        pdf.setFont('helvetica', 'normal');
        pdf.setTextColor(107, 114, 128);
        pdf.text('Generated by Aeris-AQ AI Assistant', margin, pageHeight - 10);
      ...
      for (const block of blocks) {
        switch (block.type) {
          case 'header': {
            checkNewPage(25);
            yPosition += block.level === 1 ? 8 : 5;

            const fontSize =
              block.level === 1 ? 18 : block.level === 2 ? 15 : 13;
          ...
          case 'code': {
            ...
            const estimatedHeight = codeLines.length * 4.5 + 18;
